<?php
define('C_REST_CLIENT_ID','local.67e29f9bd39222.73091908');//Application ID
define('C_REST_CLIENT_SECRET','ebUppZw6yuqIbqfsG472mTKHo6BRT5rl6eLAEX0qCIVVGXzVkI');//Application key
// or
